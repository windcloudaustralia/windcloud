    ...
    if ($query->num_rows > 0) {
        ...
        if (empty($error)) {
            ...
            if ($result) {
                ...
                $error .= '<p class="error">Something went wrong. Please email hello@windcloud.com.au as soon as possible, and we will resolve this issue</p>';
            }
        }
...
<head>
    <meta charset="UTF-8">
    <title>Sign Up - Wind Cloud</title>
